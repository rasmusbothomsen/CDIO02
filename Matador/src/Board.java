...
public class Board {
    ...
    public Board(){
        field = new String[][]{{"You have arrived at the Tower", "+250"},{"You stumbled into the Crater","-100"},{"You approach the Palace gates","+100"},
                ...
                {"You climbed up to the Huts in the mountain","+60"},{"You bumped into The Werewall \n You will recieve an extra turn","-80"},{"You fell into The pit","-50"},{"Du landede på feltet Goldmine","+650"}};
